...
from ContinuumElectrostatics import MEADModel, StateVector, TitrationCurves, MCModelDefault, MCModelGMCT


parameters = ["toppar/par_all27_prot_na_fixed.inp", "toppar/par_iron_sulfur.inp", ]

mol = CHARMMPSFFile_ToSystem ("rubredoxin_xplor.psf", isXPLOR=True, parameters=CHARMMParameterFiles_ToParameters (parameters))
mol.coordinates3 = CHARMMCRDFile_ToCoordinates3 ("rubredoxin.crd")
