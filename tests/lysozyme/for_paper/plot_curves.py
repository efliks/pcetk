...
#===========================================================
transl = {"curves_analytic" : "analytic", "curves_mc" : "MC"}
...
for site_serial, site_name, instance_label in instances:
    if (site_name, site_serial) in select:
        ox = x * 0.25
        oy = 0.75 - y * 0.20
        title = "%s%d (%s)" % (site_name.capitalize (), site_serial, transl_labels[site_name][instance_label])
