...
set   style line  1  lc rgb "blue"     lw 2     lt 1        # parent
set   style line  2  lc rgb "red"      lw 2     lt 1        # IFP 1.0
set   style line  3  lc rgb "black"    lw 2     lt 1        # IFP 1.1
...
set   style line  8  lc rgb "blue"     lw 4     lt 2        # parent
set   style line  9  lc rgb "red"      lw 4     lt 2        # IFP 1.0
set   style line 10  lc rgb "black"    lw 4     lt 2        # IFP 1.1
