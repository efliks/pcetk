...
trainAccopt = TrainingSet ("cationic_acids", acids, "accopt")
trainAccopt.CalculateCorrectionFunction ()
trainAccopt.CorrectAcids ()
trainAccopt.WriteTable (filename="accopt_fit.dat", sortByExperiment=True)

trainB3LYP = TrainingSet ("cationic_acids", acids, "b3lyp")
trainB3LYP.CalculateCorrectionFunction ()
trainB3LYP.CorrectAcids ()
trainB3LYP.WriteTable (filename="b3lyp_fit.dat", sortByExperiment=True)
