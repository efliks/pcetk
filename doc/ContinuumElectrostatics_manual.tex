...
\begin{itemize}
  ...
  \item pDynamo 1.8.0
  \item Python 2.7
  \item Pyrex 0.9.8.5 (optionally, for recompiling Pyrex sources)
...
%
In the \texttt{Makefile}, change the line starting from \makebox{"PDYNAMO\_ROOT"}
to the location of your pDynamo installation.
%
...
{\footnotesize \begin{lstlisting}
vector = StateVector_FromProbabilities (ce_model)
\end{lstlisting} }
...
{\footnotesize \begin{lstlisting}
sites = (("PRTA", "ASP",  2), ("PRTA", "GLU", 14), ("PRTA", "ARG", 15), ("PRTA", "CYS", 31))
...
{\footnotesize \begin{lstlisting}
-------------------------------------------------------------------------------
State Gmicro Charge  Protons  PRTA ASP 2  PRTA GLU 14  PRTA ARG 15  PRTA CYS 30
-------------------------------------------------------------------------------
    1    0.00     -1       2      d           d            p            p      
    2    4.55      0       3      p           d            p            p      
    3    6.69     -2       1      d           d            d            p      
    ...
    8   16.48     -1       2      d           p            p            d      
    9   16.62     -1       2      d           p            d            p      
   10   19.79     -1       2      p           d            p            d      
   11   21.13      0       3      p           p            p            d      
   12   21.40      0       3      p           p            d            p      
   13   22.25     -3       0      d           d            d            d      
   14   23.21     -2       1      d           p            d            d      
   15   26.61     -2       1      p           d            d            d      
   16   27.83     -1       2      p           p            d            d      
-------------------------------------------------------------------------------
\end{lstlisting} }
\linespread{1.6}
