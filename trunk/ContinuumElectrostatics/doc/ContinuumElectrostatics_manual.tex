...
%
It should generate library \texttt{StateVector.so} in the directory \texttt{Continuum\-Electrostatics/}.
%
In case of problems, it may be necessary to manually specify the location of the pCore module in the {\texttt{pyrex\_compile.py} script.
...
{\footnotesize \begin{lstlisting}
Gmicro = vector.CalculateMicrostateEnergy (ce_model)
\end{lstlisting} }
