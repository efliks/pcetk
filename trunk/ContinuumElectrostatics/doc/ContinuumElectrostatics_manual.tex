...
%
MEAD is a program developed by Donald Bashford\cite{Bashford1992} and extended 
by Timm Essigke\cite{Essigke_PhD} and Thomas Ullmann.
%
...
%
To avoid this behaviour, remove the scratch directory or declare another one
...
% For a given site, the probability of occurance of a particular instance is calculated 
...
%
The default behaviour can be changed by passing the "pH" argument. 
...
\bigskip
The resulting tables show for each site the probability of occurance of each instance. 
%
Instances with the highest probability of occurance are marked with "*".
%
...
titratable sites, for example aspartate:
