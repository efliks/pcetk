...
However, substate energies can be calculated easier with the \texttt{SubstateEnergies} function:

{\footnotesize \begin{lstlisting}
substate = (("PRTA", "ASP",  2), ("PRTA", "GLU", 14), ("PRTA", "ARG", 15), ("PRTA", "CYS", 31))
...
{\footnotesize \begin{lstlisting}
-----------------------------------------------------------------------
 State  Gmicro   PRTA ASP 2    PRTA GLU 14   PRTA ARG 15   PRTA CYS 31
-----------------------------------------------------------------------
     1     0.00      d             d             p             p       
     2     4.55      p             d             p             p       
     3     6.69      d             d             d             p       
