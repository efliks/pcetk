...
\usepackage{xspace, listings, setspace, geometry}
...
%
In the \texttt{Makefile}, edit the first line starting from \makebox{"PDYNAMO\_PCORE"}.
%
...
{\footnotesize \begin{lstlisting}
from ContinuumElectrostatics import TitrationCurves
tc = TitrationCurves (cem, method="GMCT")
tc.CalculateCurves ()
tc.WriteCurves (directory="curves_gmct")
\end{lstlisting} }
